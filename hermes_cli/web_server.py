...
_BUILTIN_DASHBOARD_THEMES = [
    {"name": "default",       "label": "Valley Console",      "description": "Light Valley-inspired operator console"},
    {"name": "default-large", "label": "Valley Console (Large)", "description": "Valley Console with bigger fonts and roomier spacing"},
